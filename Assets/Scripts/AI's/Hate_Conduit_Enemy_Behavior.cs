...
public class Hate_Conduit_Enemy_Behavior : Base_Enemy
{
    public Hate_Conduit_Idle_State idle_state;
    public Hate_Conduit_Attack_State attack_state;
...
/**
 * In this state, the Hate Conduit should stand still, dealing damage on contact.
 **/
public class Hate_Conduit_Idle_State : AI_State
{
 ...
 **/
public class Hate_Conduit_Attack_State : AI_State
{
    public override void Init(Base_Enemy context)
    {
